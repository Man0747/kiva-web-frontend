...
const Cabinet = () => {
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="flex flex-col items-center space-y-4 max-w-4xl pt-6 pb-60">
        {" "}
        ...
        />
        <span className="text-1xl font-medium tracking-tight text-center max-w-xl">
        ...
        {/* "View More" button */}
        <button className="px-4 py-2 mt-2 bg-blue-500 text-white rounded-lg shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
          View More
        </button>
      </div>
    </div>
